 ...
 * transição daí em diante (T-045). {@code status_anterior} e {@code motivo} ficam
 * ausentes do JSON quando nulos, nunca presentes como {@code null} - a fotografia e a
 * transição inicial não têm status anterior.
 */
